[06.03.2026 17:34] NORVIX Xn: -- Завантаження бібліотеки (це і є "готова" частина, яку написали розробники Rayfield)
...
local MainTab = Window:CreateTab("MENU1", 92653115)
...
local MainTab = Window:CreateTab("MENU2", 6344756224)
...
[06.03.2026 17:34] NORVIX Xn: -- Кнопка в меню
MainTab:CreateButton({
